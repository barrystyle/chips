...
{
    // Windows: C:\Users\Username\AppData\Roaming\Chips
    // macOS: ~/Library/Application Support/Chips
    // Unix-like: ~/.chips
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Chips";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Chips";
#else
    // Unix-like
    return pathRet / ".chips";
#endif
#endif
}
